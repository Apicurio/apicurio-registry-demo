...
public class ConsumerApplication {
    ...
    public static void main(String [] args) throws Exception {
        ...
        props.putIfAbsent(ConsumerConfig.GROUP_ID_CONFIG, "Consumer-" + ApplicationConstants.TOPIC_NAME);
        ...
        consumer.subscribe(Collections.singletonList(ApplicationConstants.TOPIC_NAME));
